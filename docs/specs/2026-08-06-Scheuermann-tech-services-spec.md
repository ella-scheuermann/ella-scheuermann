...
1. **Covered Interest Rate Parity**
   ...
   The implied forward rate should approximately equal F0_in. A difference of less than or equal to 0.001 USD/EUR will be considered PASS. Larger differences should display REVIEW and prompt investigation of the model inputs or calculations.

2. **Forward and Money Market Agreement**

   The forward hedge proceeds and money-market hedge proceeds should agree within a rounding tolerance of **$100**. If the absolute difference is **$100 or less**, the validation should display **PASS**. Differences greater than **$100** should display **REVIEW** and prompt investigation of the model inputs or calculations.
...
7. **Sensitivity Analysis Validation**
